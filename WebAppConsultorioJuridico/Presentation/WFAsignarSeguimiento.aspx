<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WFAsignarSeguimiento.aspx.cs" Inherits="Presentation.WFAsignarSeguimiento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card m-1">
        <div class="card-header">
            Gestión de Seguimientos caso: <asp:Label ID="LBNombrecaso" runat="server" Text=""></asp:Label>
        </div>
        <div class="card-body">
            <form id="FrmAsignarSeguimiento" runat="server">
                <%--ID--%>
                ...
                "columns": [
...

                    {
                        ...
                        "render": function (data, type, row) {
                            return `<button class="btn btn-link btn-lg px-0 edit-btn" data-id="${row.SeguimientoID}" style="color:#fd7e14" title="Editar"><i class="lni lni-pencil-1"></i></button>
                                  <button class="btn btn-link btn-lg text-danger px-0 delete-btn" data-id="${row.SeguimientoID}" title="Eliminar"><i class="lni lni-trash-3"></i></button>`;
                        }
                    }
                ],
                "language": {
