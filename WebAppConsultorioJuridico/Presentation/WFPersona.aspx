...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card m-1">
        ...
        <div class="card-body">
            <form id="FrmPersona" runat="server" class="container mt-4">
                <%--ID--%>
                ...
                "columns": [
                    ...
                    { "data": "correo" },
                    {
                        ...
                        "render": function (data, type, row) {
                            return `
                                        <button class="btn btn-link btn-lg px-0 edit-btn" data-id="${row.idpersona}" title="Editar" style="color:#fd7e14">
                                            <i class="lni lni-pencil-1"></i>
                                        </button>
                                        <button class="btn btn-link btn-lg text-danger px-0 delete-btn" data-id="${row.idpersona}" title="Eliminar">
