                ...
                "columns": [
                    ...
                    { "data": "NivelEscolaridad", "visible": true },
                    {
                        ...
                        "render": function (data, type, row) {
                            return `
                            <button class="btn btn-link btn-lg px-0 edit-btn" data-id="${row.CasoHasPersonaID}" title="Editar" style="color:#fd7e14">
                                <i class="lni lni-pencil-1"></i>
                            </button>
                            <button class="btn btn-link btn-lg text-danger px-0 delete-btn" data-id="${row.CasoHasPersonaID}" title="Eliminar">
